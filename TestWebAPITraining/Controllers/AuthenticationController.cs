...
namespace TestWebAPITraining.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        private class TrainingInfoUser
        {
        ...
        private TrainingInfoUser ValidateUserCredentials(string? userName, string? password)
        {
            ...
            // return a new TrainingInfoUser (values would normally come from your user DB/table)
